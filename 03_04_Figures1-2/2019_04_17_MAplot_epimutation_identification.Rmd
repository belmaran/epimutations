---
title: "2019_04_17_MAplot_filtering"
author: "Toni Beltran"
date: "17/04/2019"
output: html_document
---

This code identifies epimutation events as fold changes between two conditions that are extremely large relative to the distribution of fold changes of genes with the same mean 22G-RNA expression. To do this, the log2 fold change as well as the log2(mean abundance) are calculated between two conditions genome-wide and plotted (log2 FC in the y axis and log2(mean) in the x), and a smoothing function is applied to the data. A Z-score based on a normal distribution is calculated for each data point as the (y-value-mean of the smoothing curve)/standard dev of smoothing curve. P-values are then derived on from the normal distribution and FDR multiple testing correction is applied.  
...
Code to specifically plot Figure 1B.
