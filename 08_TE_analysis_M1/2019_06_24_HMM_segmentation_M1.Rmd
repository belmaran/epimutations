---
title: "2016_06_24_HMM_segmentation_M1"
author: "Toni Beltran"
date: "24/06/2019"
...
library(DESeq2)
ttg_A_rawcounts<-read.table("22G_counts/final_counts_table/all_counts_M1.txt"); ttg_A_rawcounts<-ttg_A_rawcounts[,c(50:61)]
ttg_B_rawcounts<-read.table("22G_counts/final_counts_table/all_counts_M1.txt"); ttg_B_rawcounts<-ttg_B_rawcounts[,c(62:73)]
...
ggsave("HMM_segmentation_duration_barplots_A.pdf",dpi="retina")
...
ggsave("../HMM_segmentation_duration_barplots_B.pdf",dpi="retina")
...
ggsave("HMM_segmentation_duration_barplots_bothAB.pdf",dpi="retina")


write.table(epimut_duration_hmm_A,file="epimut_duration_batchremoved_HMM_linA_JOINT_p1e-4.txt",quote = FALSE,row.names = FALSE,sep="\t")
write.table(epimut_duration_hmm_B,file="epimut_duration_batchremoved_HMM_linB_JOINT_p1e-4.txt",quote = FALSE,row.names = FALSE, sep="\t")
