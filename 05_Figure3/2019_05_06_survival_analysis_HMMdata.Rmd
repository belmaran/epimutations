---
title: "2019_05_06_survival_analysis_HMMdata"
author: "Toni Beltran"
date: "06/05/2019"
...
This Rmd document applies the same survival analyses as in the k-means segmented data survival analysis Rmd, to the HMM segmentation data.
...
duration_A<-read.table("epimut_duration_batchremoved_hmm_linA_JOINT_p1e-4_FCdata_noiso.txt",sep="\t",header=TRUE)
duration_B<-read.table("epimut_duration_batchremoved_hmm_linB_JOINT_p1e-4_FCdata_noiso.txt",sep="\t",header=TRUE)
...
ggsave("survival_curves_by_lineage_HMM_p1e-4.pdf")
...
ggsave("survival_curves_UP_vs_DOWN_HMM_p1e-4.pdf")
...
ggsave("survival_hmm_22G_totalchange.pdf")
...
ggsave("survival_UP_epimutations_p1e-4_by_chromatin_domain_type_hmm.pdf")
...
summary(fit_geneinfo)
ggsurvplot(fit_geneinfo, data=duration_both_geneinfo,pval = TRUE)
ggsave("survival_UP_epimutations_p1e-4_piRNAtargets_hmm.pdf")
ggsurvplot(fit_geneinfo, data=duration_both_geneinfo,pval = TRUE,fun = "cumhaz")
...
summary(fit_geneinfo)
ggsurvplot(fit_geneinfo, data=duration_both_geneinfo,pval = TRUE)
ggsave("survival_UP_epimutations_p1e-4_PATCs_hmm.pdf")
ggsurvplot(fit_geneinfo, data=duration_both_geneinfo,pval = TRUE,fun = "cumhaz")
...
summary(fit_geneinfo)
ggsurvplot(fit_geneinfo, data=duration_both_geneinfo,pval = TRUE)
ggsave("survival_UP_epimutations_p1e-4_CSR1targets_hmm.pdf")
ggsurvplot(fit_geneinfo, data=duration_both_geneinfo,pval = TRUE,fun = "cumhaz")
...
summary(fit_geneinfo)
ggsurvplot(fit_geneinfo, data=duration_both_geneinfo,pval = TRUE)
ggsave("survival_UP_epimutations_p1e-4_HRDE1targets_hmm.pdf")
ggsurvplot(fit_geneinfo, data=duration_both_geneinfo,pval = TRUE,fun = "cumhaz")
...
summary(fit_geneinfo)
ggsurvplot(fit_geneinfo, data=duration_both_geneinfo,pval = TRUE)
ggsave("survival_UP_epimutations_p1e-4_WAGO1targets_hmm.pdf")
ggsurvplot(fit_geneinfo, data=duration_both_geneinfo,pval = TRUE,fun = "cumhaz")
